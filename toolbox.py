...
def rrs(in_path: str, sensor_type: str, dest: str) -> None:
    """
    ...
    for file in os.listdir(in_path):
        try:
            ...
            if sensor_type == 'PACE_OCI':
                # Solar spectrum from Coddington et al. (2021) resampled by 11-nm:
                sun_spectrum = {'340': 93.457475, '380': 107.39304999999999, '400': 148.92693000000003, '412': 176.72970000000004,
                            '440': 186.30949999999999, '443': 189.72895, '490': 193.92055, '500': 195.9617, '510': 195.8525,
                            '531': 190.84314999999998, '532': 192.0368, '551': 189.90320000000003, '555': 187.60229999999999,
                            '560': 185.60915000000003, '620': 167.83525, '667': 154.29790000000003, '675': 151.56085000000002,
                            '681': 149.534, '709': 139.85550000000003, '779': 118.61035000000001, '865': 94.63915,
                            '870': 93.14135000000002, '1020': 70.14430000000002}
            else:
                # Solar spectrum from Thuillier (2003) resampled by 11-nm:
                sun_spectrum = {'340': 97.8851, '380': 109.21014500000001, '400': 154.687015, '412': 171.03303499999998,'440': 183.80075000000002,
                                '443': 188.92312, '490': 192.861705, '500': 193.74013, '510': 192.77944499999998, '531': 185.90661500000002,
                                '532': 187.08975999999998, '551': 187.02424500000004, '555': 183.89774, '560': 180.06239, '620': 164.95923499999998,
                                '667': 152.38098499999995, '675': 149.17576999999997, '681': 147.04998500000002, '709': 140.39591000000001, '779': 116.95122,
